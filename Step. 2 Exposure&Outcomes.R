...
{#* section 1.1 NHANES III Periodontitis diagnosis ####
  {#** section 1.1.1 Data Preparation ####
    PD_dia=read.table("I:/NHANES study/PD&TYG&MO/Data/NHANESIII/exam.dat",sep=",",fill=T)
  ...
  {#** section 1.1.7 data selction age>=30 ####
    adult=read.table("I:/NHANES study/PD&TYG&MO/Data/NHANESIII/adult.dat",sep=",",fill=T)
    ...
    save(PD_III,file="I:/NHANES study/PD&TYG&MO/Data/PD_III.Rdata")
  }
}
{#* section 1.2 NHANES 1999-2004 Periodontitis diagnosis ####
  {#** section 1.2.1 Data Preparation ####
    #periodontal_data
    OHXPER_9900<-read.xport("I:/NHANES study/PD&TYG&MO/Data/PD/OHXPERIO.XPT")
    OHXPERL_0102<-read.xport("I:/NHANES study/PD&TYG&MO/Data/PD/OHXPRL_B.XPT")
    OHXPERU_0102<-read.xport("I:/NHANES study/PD&TYG&MO/Data/PD/OHXPRU_B.XPT")
    OHXPERL_0304<-read.xport("I:/NHANES study/PD&TYG&MO/Data/PD/OHXPRL_C.XPT")
    OHXPERU_0304<-read.xport("I:/NHANES study/PD&TYG&MO/Data/PD/OHXPRU_C.XPT")
  ...
  {#** section 1.2.7 data selction age>=30 ####
    ...
    save(PD_CON1,file="I:/NHANES study/PD&TYG&MO/Data/PD_CON1.Rdata")
  }
}
{#* section 1.3 NHANES 2009-2014 Periodontitis diagnosis ####
  {#** section 1.3.1 Data Preparation ####
    ...
    setwd("I:/NHANES study/PD&TYG&MO/Data/PD")
  ...
  {#** section 1.3.8 data selction age>=20 ####
    ...
    save(PD_CON2,file="I:/NHANES study/PD&TYG&MO/Data/PD_CON2.Rdata")
  }
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 2. TYG Data <<<<< ####
exam=read.table("I:/NHANES study/PD&TYG&MO/Data/NHANESIII/exam.dat",sep=",",fill=T)
exam$SEQN<-as.numeric(substring(exam$V1,1,5))
adult=read.table("I:/NHANES study/PD&TYG&MO/Data/NHANESIII/adult.dat",sep=",",fill=T)
adult$SEQN<-as.numeric(substring(adult$V1,1,5))
lab=read.table("I:/NHANES study/PD&TYG&MO/Data/NHANESIII/lab.dat",sep=",",fill=T)
lab$SEQN<-as.numeric(substring(lab$V1,1,5))

{#* section 2.1 NHANES III TYG Data ####
    #Triglycerides
    Lab_III<-as.data.frame(lab$SEQN)
    colnames(Lab_III)<-c("SEQN")
    Lab_III$TGP<-as.numeric(substring(lab$V1,1606,1609))
    Lab_III$TGP[Lab_III$TGP==8888]<-NA
    summary(Lab_III$TGP,useNA = "ifany")
    #Fasting glucose
    Lab_III$G1P<-as.numeric(substring(lab$V1,1866,1870))
    Lab_III$G1P[Lab_III$G1P==88888]<-NA
    summary(Lab_III$G1P,useNA = "ifany")
    #BMI
    Exam_III<-as.data.frame(exam$SEQN)
    colnames(Exam_III)<-c("SEQN")
    Exam_III$BMI<-as.numeric(substring(exam$V1,1524,1527))
    Exam_III$BMI[Exam_III$BMI==8888]<-NA
    #Waist circumference/height
    Exam_III$Waist<-as.numeric(substring(exam$V1,1590,1594))
    Exam_III$Waist[Exam_III$Waist==88888]<-NA
    Exam_III$Height<-as.numeric(substring(exam$V1,1528,1532))
    Exam_III$Height[Exam_III$Height==88888]<-NA
    TYG_III<-merge(Lab_III,Exam_III,by='SEQN',
               all =T)
    #TyG=ln [triglycerides (mg/dl)×glucose (mg/dl)/2]
    TYG_III$TYG <- log((TYG_III$TGP * TYG_III$G1P) / 2)
    TYG_III$WHtR<-TYG_III$Waist/TYG_III$Height
    TYG_III$TyG_WC<-TYG_III$TYG*TYG_III$Waist
    TYG_III$TyG_WHtR<-TYG_III$TYG*TYG_III$WHtR
    TYG_III$TyG_BMI<-TYG_III$TYG*TYG_III$BMI
    colnames(TYG_III)
    save(TYG_III,file="I:/NHANES study/PD&TYG&MO/Data/TYG_III.Rdata")

}

{#* section 2.1 NHANES 1999-2004 Exclusion Data ####

    TGP_9900<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/LAB13AM.xpt")
    TGP_0102<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/L13AM_B.xpt")
    TGP_0304<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/L13AM_C.xpt")
    TGP_CON1<-rbind(TGP_9900[,c("SEQN","LBXTR")],
                    TGP_0102[,c("SEQN","LBXTR")],
                    TGP_0304[,c("SEQN","LBXTR")])
    G1P_9900<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/LAB10AM.xpt")
    G1P_0102<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/L10AM_B.xpt")
    G1P_0304<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/L10AM_C.xpt")
    ...
    Exam_9900<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/BMX.xpt")
    Exam_0102<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/BMX_B.xpt")
    Exam_0304<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/BMX_C.xpt")
    ...
    colnames(TYG_CON1)
    save(TYG_CON1,file="I:/NHANES study/PD&TYG&MO/Data/TYG_CON1.Rdata")

}


{#* section 2.1 NHANES 2009-2014 Exclusion Data ####
  TGP_0910<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/TRIGLY_F.xpt")
  TGP_1112<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/TRIGLY_G.xpt")
  TGP_1314<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/TRIGLY_H.xpt")
  TGP_CON2<-rbind(TGP_0910[,c("SEQN","LBXTR")],
                  TGP_1112[,c("SEQN","LBXTR")],
                  TGP_1314[,c("SEQN","LBXTR")])
  G1P_0910<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/GLU_F.xpt")
  G1P_1112<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/GLU_G.xpt")
  G1P_1314<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/GLU_H.xpt")
  ...
  Exam_0910<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/BMX_F.xpt")
  Exam_1112<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/BMX_G.xpt")
  Exam_1314<-read.xport("I:/NHANES study/PD&TYG&MO/Data/TYG/BMX_H.xpt")
  ...
  colnames(TYG_CON2)
  save(TYG_CON2,file="I:/NHANES study/PD&TYG&MO/Data/TYG_CON2.Rdata")
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
save(EX_III,file="I:/NHANES study/PD&TYG&MO/Data/EX_III.Rdata")
...
save(EX_CON1,file="I:/NHANES study/PD&TYG&MO/Data/EX_CON1.Rdata")
...
save(EX_CON2,file="I:/NHANES study/PD&TYG&MO/Data/EX_CON2.Rdata")
...
{#* section 5.1 NHANES III Ascertainment of Mortality ####
  MORT_III=read.table("I:/NHANES/mort/nhanes_iii_mort_2019_public.tsv",header = T,sep = "\t",fill = F)
  MORT_III <- MORT_III %>%
...
save(MORT_III,file="I:/NHANES study/PD&TYG&MO/Data/MORT_III.Rdata")
save(MORT_CON1,file="I:/NHANES study/PD&TYG&MO/Data/MORT_CON1.Rdata")
save(MORT_CON2,file="I:/NHANES study/PD&TYG&MO/Data/MORT_CON2.Rdata")
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 4.  <<<<< ####
load(file="I:/NHANES study/PD&TYG&MO/Data/TYG_III.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/TYG_CON1.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/TYG_CON2.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/PD_III.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/PD_CON1.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/PD_CON2.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/EX_III.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/EX_CON1.Rdata")
load(file="I:/NHANES study/PD&TYG&MO/Data/EX_CON2.Rdata")
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
III<-multimerge(list(TYG_III,PD_III,EX_III),by="SEQN",all=T)
TYG_III<-subset(III,!is.na(TYG))
TYG_PD_III<-subset(TYG_III,!is.na(PD_diagnosis))
...
TYG_PD_III$Pregnancy[is.na(TYG_PD_III$Pregnancy)]<-"NO"
TYG_PD_CON1$Pregnancy[is.na(TYG_PD_CON1$Pregnancy)]<-"NO"
TYG_PD_CON2$Pregnancy[is.na(TYG_PD_CON2$Pregnancy)]<-"NO"
TYG_PD_III<-na.omit(TYG_PD_III)
TYG_PD_III<-subset(TYG_PD_III,Pregnancy=="NO")
TYG_PD_III$Pregnancy<-NULL
...
save(TYG_PD_III,file="I:/NHANES study/PD&TYG&MO/Data/TYG_PD_III.Rdata")
save(TYG_PD_CON1,file="I:/NHANES study/PD&TYG&MO/Data/TYG_PD_CON1.Rdata")
save(TYG_PD_CON2,file="I:/NHANES study/PD&TYG&MO/Data/TYG_PD_CON2.Rdata")


# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 6. Combine of PD & DM & Mortality <<<<< ####
{#* section 6.1 NHANES III Combine of data ####
  load(file="I:/NHANES study/PD&TYG&MO/Data/TYG_PD_III.Rdata")
  load(file="I:/NHANES study/PD&TYG&MO/Data/MORT_III.Rdata")
  III_base_mo_stat<-merge(TYG_PD_III,MORT_III,by = "SEQN",all= F)
...
{#* section 6.2 NHANES 1999-2004 Combine of data ####
  load(file="I:/NHANES study/PD&TYG&MO/Data/TYG_PD_CON1.Rdata")
  load(file="I:/NHANES study/PD&TYG&MO/Data/MORT_CON1.Rdata")
  CON1_base_mo_stat<-merge(TYG_PD_CON1,MORT_CON1,by = "SEQN",all.x = T)
...
{#* section 6.3 NHANES 2009-2014 Combine of data ####
  load(file="I:/NHANES study/PD&TYG&MO/Data/TYG_PD_CON2.Rdata")
  load(file="I:/NHANES study/PD&TYG&MO/Data/MORT_CON2.Rdata")
  CON2_base_mo_stat<-merge(TYG_PD_CON2,MORT_CON2,by = "SEQN",all.x = T)
...
save(III_baseline,file="I:/NHANES study/PD&TYG&MO/Data/III_baseline.Rdata")
save(CON1_baseline,file="I:/NHANES study/PD&TYG&MO/Data/CON1_baseline.Rdata")
save(CON2_baseline,file="I:/NHANES study/PD&TYG&MO/Data/CON2_baseline.Rdata")
